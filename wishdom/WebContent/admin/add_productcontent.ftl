...
<div class="details">
	<table width="100%">
		<tr align="center">
			<td>
				<b style="font-size:16px">编辑产品内容</b>
				<hr>
			</td>
		</tr>
		<tr>
...
<script type="text/javascript">
	...
	function submit(){
		...
		if(hascontent==true){
			...
			$.post('${contextPath}/admin/update_productcontent.htm',{content:content,productId:'${productId}'},function(data){if(data=='success'){alert("保存成功");}else{alert("保存失败");}});
			return;
		}else{
			alert("请先填写产品的图片内容");
			return;
